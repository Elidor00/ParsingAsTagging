...
class Pat(nn.Module):
    ...
    def __init__(self, args, word_vocab, tag_vocab, pos_vocab, deprel_vocab, char_vocab):
        ...
        self.hidden2_to_dep = nn.Linear(
            in_features=self.bilstm_input_size * 2 if self.use_head else self.bilstm_input_size,
            # in_features value depending on whether the head is used or not
    ...
    def forward(self, sentences):
        ...
        # Note: without relu, dropout and relu, the metric values are better
