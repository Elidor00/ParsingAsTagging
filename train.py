...
parser.add_argument('--position-emb-max-pos', type=int, default=150, help='max position that can be encoded to embeddings')  # input = number of different words
parser.add_argument('--position-emb-size', type=int, default=20, help='position embeddings size')  # output = max sentence length
